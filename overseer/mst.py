# -*- coding: utf-8 -*-
"""
Computes maximum spanning tree of a weighted graph.

Modified from networkx.algorithms.mst
"""
...
def maximum_spanning_edges(G, weight='weight', data=True):
    ...
    with the maximum sum of edge weights.  A spanning forest is a
...
kruskal_mst = maximum_spanning_tree
